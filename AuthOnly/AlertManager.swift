...
//  AuthOnly
//
//  Created by subrata Samartha on 30/06/23.
//
...
extension AlertManager {
    public static func showRegistrationErrorAlert(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Unknown Regestration Error", message: nil)
    }
    
    public static func showRegistrationErrorAlert(on vc: UIViewController, with error:Error) {
        self.showBasicAlert(on: vc, title: "Unknown Regestration Error", message: "\(error.localizedDescription)")
    }
}
...
extension AlertManager {
    public static func showPasswordResentSent(on vc: UIViewController) {
